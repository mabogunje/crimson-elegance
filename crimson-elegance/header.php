...
<div id="page" class="hfeed">
	...
	<header id="branding" role="banner">
            ...
            <?php
                ...
                $recent = get_recent_cat(); 
                $iD = $recent->cat_ID; 
                $name = $recent->name; 
                $blurb = category_description($recent->cat_ID); 
                $blurb_length = strlen($blurb);
                $truncate = 240;
            ?>
            ...
            <div id="skiptolatest"> 
                <h3><?php echo $name; ?></h3>
                <p>
                    <?php _e(trim(substr($blurb, 0, $truncate))); ?>
                    <?php if($blurb_length > $truncate) { echo '...'; } ?>
                </p>
                <a href="<?php echo get_category_link($recent->cat_ID); ?>">Read Edition</a>
            </div>
	</header><!-- #branding -->
